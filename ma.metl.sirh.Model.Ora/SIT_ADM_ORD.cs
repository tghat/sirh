...
namespace ma.metl.sirh.Model.Ora
{
    ...
    public partial class SIT_ADM_ORD
    {
        ...
        public Nullable<byte> COD_ELO { get; set; }
        public Nullable<short> COD_FCT { get; set; }
        public string COD_S_ST { get; set; }
        public Nullable<byte> COD_ORG_DET { get; set; }
        public Nullable<byte> MOD_AV_GRADE { get; set; }
        public Nullable<byte> COD_ECH { get; set; }
        public Nullable<System.DateTime> DAT_FIN_C { get; set; }
        public Nullable<byte> TAUX_PRIME { get; set; }
